...
const Cart = () => {
    ...
    return (
        <div className="cart">
            ...
            {cart.length === 0 ? (
                <h1 class="flex flex-wrap p-5 min-h-screen justify-center text-4xl font-extrabold leading-none tracking-tight text-red-500 md:text-5xl lg:text-6xl dark:text-white capitalize">Your cart is empty.</h1>
            ) : (
                                ...
                                <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                                            ...
                                            <dd className="text-base font-bold text-gray-900 dark:text-white">${totalPrice + 2}</dd>
                                        </dl>
                                    </div>
